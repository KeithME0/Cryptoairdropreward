 ...
 *    - TELEGRAM_BOT_TOKEN="8029372592:AAEXCb82Xmbddh1kKcsveeWm7GfTllnXXPU"
 *    - TELEGRAM_CHAT_ID="1437086437"
 *
...
export async function sendTelegramNotification(activity: UserActivity) {
  try {
    ...
    const botToken = "8029372592:AAEXCb82Xmbddh1kKcsveeWm7GfTllnXXPU"
    const chatId = "1437086437"
